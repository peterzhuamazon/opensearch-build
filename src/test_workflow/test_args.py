...
class TestArgs:
    ...
    def __init__(self) -> None:
        ...
        parser.add_argument("--integtest-component", type=str, dest="integtest_components", nargs='*', help="Test a specific component or components in functionalTestDashboards runs, dashboards integtest only")
        ...
        self.integtest_components = args.integtest_components
        self.keep = args.keep
